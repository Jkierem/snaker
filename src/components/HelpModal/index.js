...
const globalObjects = `type Snake = {
   turnLeft: () => void,
   turnRight: () => void,
   moveForward: () => void,
   body: [number,number][],
...
const HelpModal = ({ open, onClose }) => {
    ...
    return <div className={helpCl} onClick={handleClickOutside}>
        <div className={helpContentCl} onClick={handleClickInside}>
            ...
            <p>The goal is to program the snake to reach 100 points</p>
            ...
            <p>Auto saved is enabled. No need to save your code. Below the editor is a small debugger</p>
            <div>
